<%-- 
    Document   : Footer
    Created on : Apr 21, 2025, 12:53:09 PM
    Author     : fptshop
--%>
                ...
                <div class="col-lg-3  col-sm-6">
                    <div class="service-wrapper free-shipping">
                        ...
                        <div class="service-content">
                            ...
                            <p class="service-info service-details">Khi order trên 500k</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="service-wrapper free-shipping">
                        ...
                        <div class="service-content">
                            <h5 class="service-info service-title">Bảo hành</h5>
                            <p class="service-info service-details">Bảo hành 7 ngày cho sản phẩm</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="service-wrapper free-shipping">
                        ...
                        <div class="service-content">
                            <h5 class="service-info service-title">Thanh toán bảo mật</h5>
                            <p class="service-info service-details">100% Thanh toán online</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="service-wrapper free-shipping">
                        ...
                        <div class="service-content">
                            ...
                            <p class="service-info service-details">Chúng tôi tự tin có thể đem lại trải nghiệm tốt nhất cho bạn</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="footer-link contact-link">
                            <div class="address">
                                ...
                                <div class="details">
                                    ...
                                    <p>Km29 Đường Láng Hòa Lạc - Thạch Thất - Hà Nội</p>
                                </div>
                            </div>
