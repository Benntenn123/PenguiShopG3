                                ...
                                <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                                    <div>
                                        <button type="button" class="btn btn-light" data-bs-toggle="modal" data-bs-target="#exampleModal"
                                                data-bs-whatever="@mdo"><i class="bx bx-plus me-1"></i> Thêm sản phẩm mới</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-select" name="status">
                                                        ...
                                                        <option value="1" ${param.status == '1' ? 'selected' : ''}>Đang kinh doanh</option>
                                                        <option value="0" ${param.status == '0' ? 'selected' : ''}>Ngừng kinh doanh</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-3">
                                ...
                                <tbody>
                                    <c:forEach items="${listP}" var="product">
                                        <tr>
                                            ...
                                            <td>${product.status eq "1" ? 'Đang kinh doanh' : 'Ngừng kinh doanh'}</td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li><a class="dropdown-item" href="product_details?productID=${product.productID}">Xem chi tiết</a></li>
                                                        <li><a class="dropdown-item" href="product_edit?productID=${product.productID}">Sửa sản phẩm</a></li>
                                                        <li><a class="dropdown-item" href="product_variants?productID=${product.productID}">Xem thuộc tính</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <ul class="pagination justify-content-end" id="pagination">
                                        ...
                                        <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <a class="page-link" href="?page=${currentPage - 1}&productName=${param.productName}&status=${param.status}&type=${param.type}&brand=${param.brand}&cate=${param.cate}" tabindex="-1">
                                                        <i class="mdi mdi-chevron-left Triumvirate"></i>
                                                    </a>
                                                </c:otherwise>
                                            </c:choose>
                                        </li>
                                        ...
                                        <c:if test="${currentPage > 3}">
                                            <li class="page-item">
                                                <a class="page-link" href="?page=1&productName=${param.productName}&status=${param.status}&type=${param.type}&brand=${param.brand}&cate=${param.cate}">1</a>
                                            </li>
                                        ...
                                        <c:forEach var="i" begin="${currentPage - 2 < 1 ? 1 : currentPage - 2}" 
                                            ...
                                            <li class="page-item ${i == currentPage ? 'active' : ''}">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <a class="page-link" href="?page=${i}&productName=${param.productName}&status=${param.status}&type=${param.type}&brand=${param.brand}&cate=${param.cate}">${i}</a>
                                                    </c:otherwise>
                                                </c:choose>
                                            </li>
                                        </c:forEach>
                                        ...
                                        <c:if test="${currentPage < totalPages - 2}">
                                            ...
                                            <li class="page-item">
                                                <a class="page-link" href="?page=${totalPages}&productName=${param.productName}&status=${param.status}&type=${param.type}&brand=${param.brand}&cate=${param.cate}">${totalPages}</a>
                                            </li>
                                        </c:if>
                                        ...
                                        <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <a class="page-link" href="?page=${currentPage + 1}&productName=${param.productName}&status=${param.status}&type=${param.type}&brand=${param.brand}&cate=${param.cate}">
                                                        <i class="mdi mdi-chevron-right"></i>
                                                    </a>
                                                </c:otherwise>
                                            </c:choose>
