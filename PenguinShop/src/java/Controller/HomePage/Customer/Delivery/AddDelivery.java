...
@WebServlet(name="AddDelivery", urlPatterns={"/addDelivery"})
public class AddDelivery extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddDelivery</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddDelivery at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        if(StringConvert.isAnyFieldEmpty(info)){
            ...
            Models.DeliveryInfo di = new Models.DeliveryInfo(user,
                    info[0],
                    info[1],
                    info[2],
            ...
            if(dao.insertDeliveryInfo(di)){
                ...
                request.getSession().setAttribute("error", "Thêm địa chỉ nhận không thành công");
                response.sendRedirect("deliveryinfo");
            }
        }
    ...
    private String[] getData(HttpServletRequest request){
        ...
        return new String[]{fullname,phone,email,province,district,ward,addressDetail};
    }
    @Override
