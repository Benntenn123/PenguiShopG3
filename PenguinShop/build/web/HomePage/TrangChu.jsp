    ...
    <body>
            ...
            <div class="swiper hero-swiper">
                <c:forEach items="${banner}" var="banner">
                    <div class="hero-wrapper">
                        <div class="swiper-slide" style="padding: 0 !important; margin: 0 !important;">
                            <img src="api/img/${banner.bannerLink}" style="width: 100vw; display: block;" />
                        </div>
                    </div>
                </c:forEach>
            </div>
            <!-- Nút trước và sau -->
            <button class="swiper-button-prev" style="position: absolute; top: 70%; left: 10px; transform: translateY(-50%); z-index: 10;"></button>
            <button class="swiper-button-next" style="position: absolute; top: 70%; right: 10px; transform: translateY(-50%); z-index: 10;"></button>
        </section>
                    ...
                    <c:forEach var="cate" items="${cate}">
                        <div class="product-wrapper" data-aos="fade-right" data-aos-duration="200">
                            <div class="wrapper-img">
                                <img src="api/img/${cate.imageCategory}"style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover;" alt="${cate.categoryName}">
                            </div>
                            <div class="wrapper-info">
                                <a href="product-sidebar.html" class="wrapper-details">${cate.categoryName}</a>
                            </div>
                        </div>
                    </c:forEach>    
                </div>
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="api/img/${newArrival.product.imageMainProduct}" style="width: 308px; height: 313px; object-fit: fill; display: block; margin: 0;" 
                ...
                <div class="brand-section">
                    <c:forEach var="brand" items="${brand}">
                        <div class="product-wrapper">
                            <div class="wrapper-img">
                                <a href="">
                                    <img src="api/img/${brand.logo}" style="height: 80px; width: auto; object-fit: contain;" alt="img">
                                </a>
                            </div>
                        </div>
                    </c:forEach>
        ...
        <section class="product top-selling">
            <div class="container">
                <div class="section-title">
                    <h5>Sản phẩm hot</h5>
                    <a href="product-sidebar.html" class="view">Xem tất cả</a>
                </div>
            ...
            <div class="container">
                <div class="best-selling-section">
                    <div class="section-title">
                        ...
                        <a href="sellers.html" class="view">Xem tất cả</a>
                    </div>
                    <div class="best-selling-items">
                        <c:forEach var="sixbr" items="${sixbr}">
                            <div class="product-wrapper">
                                <div class="wrapper-img">
                                    <a href="">
                                        <img src="api/img/${sixbr.logo}" style="height: 80px; width: auto; object-fit: contain;" alt="img">
                                    </a>
                                </div>
                                <div class="wrapper-info">
                                    <a href="seller-sidebar.html" class="wrapper-details">${sixbr.brandName}</a>
                                </div>
                            </div>
                        </c:forEach>
                    </div>
                                ...
                                <div class="product-wrapper" data-aos="fade-up">
                                    <div class="product-img">
                                        <img src="api/img/${top4Week.product.imageMainProduct}"
                                             style="width: 308px; height: 313px; object-fit: fill; display: block; margin: 0;" 
