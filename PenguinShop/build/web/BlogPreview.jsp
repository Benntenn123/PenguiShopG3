...
<html>
    <head>
        ...
        <style>
            ...
            .blog-preview-container {
                margin-top: 120px; /* Adjusted for homepage header */
                margin-bottom: 50px;
            }
            .blog-title {
                font-size: 2.5rem;
    ...
    <body>
        ...
        <!-- Bootstrap JS -->
        <script src="HomePage/js/bootstrap-5.3.2.bundle.min.js"></script>
        <!-- jQuery -->
        <script src="HomePage/js/jquery_3.7.1.min.js"></script>
        <!-- Include HomePage JS -->
